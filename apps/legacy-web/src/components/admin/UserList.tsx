    ...
    return (
        <div className="p-4 bg-transparent">
            ...
            <div className="mb-6 flex items-center justify-between">
                <div>
                    {/* Cleaned up header for better embedding */}
                    <h2 className="text-xl font-bold tracking-tight text-white mb-1">Personnel Directory</h2>
                    <p className="text-muted-foreground text-sm">Manage system access and permissions.</p>
                </div>
                <button
                    className="bg-primary hover:bg-primary/90 text-white px-4 py-2 rounded-md flex items-center gap-2 font-medium transition-colors text-sm"
